...
//     // if (code == HC_ACTION && !upFlag)
//     // {
//     //     SendKey('X');
//     //     eatKeyStroke = TRUE;
//     // }
//     return (eatKeyStroke ? 1 : CallNextHookEx(NULL, code, key, lParam));
// }
    ...
    LPSTR lpCmdLine, int nCmdShow)
{
    ...
    // keyboardHook = SetWindowsHookExA(WH_KEYBOARD_LL, keyboard_hook, NULL, 0);
    ...
    // keyboardHook = SetWindowsHookExA(WH_KEYBOARD, keyboard_hook, NULL, GetCurrentThreadId());
 
    // keyboardHook = SetWindowsHookExA(WH_KEYBOARD, keyboard_hook, NULL, 0);
    // if (keyboardHook == NULL)
    // {
    //     ErrorExit(TEXT("SetWindowsHookExA"));
    // }
    // else
    // {
    //     MessageBox(NULL, "Hook installed.", "Alert", MB_OK);
    // }
